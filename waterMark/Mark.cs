...
namespace waterMark
{
    class Mark
    {
        ...
        public static PictureBox NewImage()
        {
            ...
            System.Drawing.Imaging.ColorMatrix clrMatrix = new System.Drawing.Imaging.ColorMatrix(setColorMatrix);
            System.Drawing.Imaging.ImageAttributes setImage = new System.Drawing.Imaging.ImageAttributes();
            setImage.SetColorMatrix(clrMatrix, System.Drawing.Imaging.ColorMatrixFlag.Default, System.Drawing.Imaging.ColorAdjustType.Bitmap);
            ...
            float miy = (float)((orgImg.Height/ 2) + (orh / 2) + (orh/4));
